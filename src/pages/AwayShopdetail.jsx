...
function AwayShopdetail(props) {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setData(props.awaykit.filter(a => a.id == id))
    }, [id])
    ...
    const ChoseSize = (e, id) => {
        ...
        props.dispatch({ type: "ADD_SIZE_AWAYKIT", payload: id, value: e.target.innerText })
...
export default connect(mapStateToProps)(AwayShopdetail)
