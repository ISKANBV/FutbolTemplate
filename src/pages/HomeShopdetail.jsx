...
function HomeShopdetail(props) {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setData(props.homekit.filter(a => a.id == id))
    ...
    const ChoseSize = (e,id) => {
        ...
        props.dispatch({type: "ADD_SIZE_HOMEKIT", payload: id, value: e.target.innerText})
            ...
            <div className="headtext">
                    ...
                    <div className="roww">
                        <OwlCarousel options={options} >
                            {props.awaykit.map((index, key) => (
                                <Link to={`/awayshopdetail/${index.id}`}>
...
export default connect(mapStateToProps)(HomeShopdetail)
